...
Current status: workspace/package foundation only.
...
- `packages/openclaw-adapter` — active TypeScript package skeleton for future OpenClaw/Telegram adapter code.
