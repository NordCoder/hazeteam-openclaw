...
const forbiddenImportAndRuntimePatterns = Object.freeze([
  ...
  [/from\s+['"](?:node:)?fs['"]/u, 'fs import'],
  [/from\s+['"](?:node:)?fs\/promises['"]/u, 'fs/promises import'],
  ...
  [/import\(\s*['"](?:node:)?(?:fs|fs\/promises|child_process|http|https|net|tls)['"]\s*\)/u, 'dynamic runtime import'],
  [/\brequire\s*\(\s*['"](?:node:)?(?:fs|fs\/promises|child_process|http|https|net|tls)['"]\s*\)/u, 'runtime require'],
  ...
  [/\bnew\s+[A-Za-z0-9_]*(?:Client|Sdk)\b/u, 'runtime client construction'],
  [/\bcreateServer\s*\(/u, 'server construction'],
